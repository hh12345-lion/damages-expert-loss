...
export const metadata = createMetadata({
  title: "Thank You | DamagesExpertWitness.co.uk",
  description:
...
const nextSteps = [
  {
    title: "Case review",
    detail:
      "We review your practice area, heads of loss, court or forum, and deadline to identify suitable quantum specialists.",
  },
  {
    title: "Expert match",
    detail:
      "You receive a response within one business day with forensic accountant, actuary, or arbitration quantum options aligned to CPR Part 35 or tribunal requirements.",
  },
  {
    title: "Instruction",
    detail:
      "Once you confirm, we facilitate introduction and support your letter of instruction, document list, and SJE or party-appointed arrangements.",
  },
];
    ...
    <>
      ...
      <Section>
        <div className="mx-auto max-w-2xl">
          <div
            className="flex flex-col items-center rounded border border-border bg-section-alt p-8 text-center shadow-card"
            role="status"
            aria-live="polite"
          >
            <span
          ...
          <h2 className="mt-12 text-xl font-bold text-heading">
            What happens next
          </h2>
            ...
            <ul className="mt-4 flex flex-wrap gap-3">
              {helpfulLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="inline-flex min-h-[44px] items-center rounded border border-border px-4 py-2 text-sm font-medium text-primary transition-colors hover:bg-section-alt"
                  >
                    {link.label}
                  </Link>
                </li>
      ...
      <section className="bg-accent py-14 md:py-16">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-primary/90">
