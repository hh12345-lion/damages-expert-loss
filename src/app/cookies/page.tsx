...
export const metadata = createMetadata({
  title: "Cookie Policy | DamagesExpertWitness.co.uk",
  description:
    "How DamagesExpertWitness.co.uk uses cookies and similar technologies. Manage your preferences and learn about GDPR-compliant cookie categories.",
  path: "/cookies",
});
      ...
      <Section>
        <article className="prose-content mx-auto max-w-3xl">
          ...
          <p>
            ...
            remain denied until you opt in.
          </p>
