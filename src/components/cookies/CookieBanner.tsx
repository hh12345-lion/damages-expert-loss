  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="overflow-hidden rounded-xl border border-white/15 bg-primary shadow-[0_8px_40px_rgba(0,0,0,0.35)] sm:rounded-2xl">
            <div className="grid gap-5 p-5 sm:p-6 md:grid-cols-[minmax(0,1fr)_auto] md:items-end md:gap-6">
              <div className="min-w-0">
                ...
                <p className="mt-2 text-sm leading-relaxed text-white/90 sm:text-[0.9375rem]">
                  ...
                  support marketing. Choose how we use them, or read our{" "}
                  <Link
                    href="/cookies"
              ...
              <div className="flex w-full flex-col gap-2 sm:flex-row sm:flex-wrap md:w-auto md:max-w-md md:justify-end lg:flex-nowrap">
                <button
                  ...
                  className="min-h-[44px] w-full whitespace-nowrap rounded-lg border border-white/35 bg-transparent px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-white/10 sm:w-auto"
                >
                ...
                <button
                  ...
                  className="min-h-[44px] w-full whitespace-nowrap rounded-lg border border-white/35 bg-white/10 px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-white/20 sm:w-auto"
                >
                  Customise
                </button>
                <button
                  type="button"
                  onClick={acceptAll}
                  className="min-h-[44px] w-full whitespace-nowrap rounded-lg bg-accent px-5 py-2.5 text-sm font-semibold text-primary shadow-md transition-colors hover:bg-accent/90 sm:w-auto"
                >
                  Accept All
                </button>
              </div>
