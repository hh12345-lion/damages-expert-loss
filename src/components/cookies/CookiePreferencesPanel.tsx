  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative z-10 flex max-h-[90vh] w-full max-w-lg flex-col overflow-hidden rounded-t-lg border border-border bg-white shadow-2xl motion-safe:animate-[slideUp_280ms_ease-out] sm:rounded-lg"
      >
        ...
        <div className="flex flex-col gap-2 border-t border-border bg-section-alt p-4 sm:flex-row sm:justify-end sm:px-6">
          <button
            type="button"
            onClick={onClose}
            className="min-h-[44px] rounded border border-border bg-white px-5 py-2.5 text-sm font-semibold text-heading hover:bg-section-alt"
          >
            Cancel
          </button>
          <button
            type="button"
            onClick={handleSave}
            className="min-h-[44px] rounded bg-accent px-5 py-2.5 text-sm font-semibold text-primary hover:bg-accent/90"
          >
            Save Preferences
          </button>
        </div>
