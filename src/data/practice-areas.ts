...
export const practiceAreas: PracticeAreaPage[] = [
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Clinical negligence quantum experts also address CRU recoupment, interest on past losses, and causation of financial loss distinct from pre-existing conditions. Reports are prepared for the High Court, County Court multi-track, and secured accommodation hearings, with methodology that supports joint expert discussions and trial in complex medico-legal litigation.",
    ],
    faqs: [
      {
        question:
      ...
      {
        question:
          "What is a periodical payments order (PPO) in clinical negligence?",
        answer:
          "A PPO replaces a lump sum award for future losses with annual payments indexed to ASHE (or another appropriate index), providing certainty that the claimant will have funds to meet future needs. Quantum experts model both the lump sum and PPO scenarios so the court can compare them.",
      },
    ],
  },
  {
