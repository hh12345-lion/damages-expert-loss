...
```mermaid
flowchart TB
  subgraph pillar [Pillar]
    TypesOfDamages["/types-of-damages"]
  end
  subgraph practiceAreas [Practice Areas]
    PI["personal-injury-quantum"]
    Clinical["clinical-negligence"]
    Commercial["commercial-damages"]
    Arbitration["international-arbitration"]
  end
  subgraph guides [Guides]
    G1["loss-of-earnings-ogden-tables"]
    G2["schedule-of-loss"]
    G3["commercial-but-for"]
    G4["arbitration-quantum"]
    G5["clinical-negligence-quantum"]
    G6["single-joint-expert"]
  end
  subgraph commercial [Site-wide]
    Services["/services"]
  ...
  TypesOfDamages --> PI
  TypesOfDamages --> Commercial
  TypesOfDamages --> Glossary
  PI --> G1
  Clinical --> G5
  Commercial --> G3
  Arbitration --> G4
...
flowchart TD
  ...
  WS["WebSite + SearchAction"]
  Svc["8x Service on /services"]
  Pillar["Article /types-of-damages"]
